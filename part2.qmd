...
This plot illustrates that the majority of **current** smokers were censored from the study.
...
This collection of plots illustrate how the individual variables trend (and change) throughout the study.
